...
def print_spicy_foods(spicy_foods)
  # your code here
  spicy_foods.map do |spice|
  puts "#{spice[:name]} (#{spice[:cuisine]}) | Heat Level: #{'🌶' * spice[:heat_level]}"
  end
end

# given an array of spicy spices and a string representing a cuisine, **return a single hash**  
...
def print_spiciest_foods(spicy_foods)
  # your code here
  highest=spiciest_foods(spicy_foods)
  print_spicy_foods(highest)
end
...
def average_heat_level(spicy_foods)
  # your code here
  total_heat=spicy_foods.sum do |spice|
    spice[:heat_level]
  end
